...
const poll = {
    ...
    registerNewAnswer() {
        ...
        console.log(answer);
        // register Answer using shortcircuiting
    ...
    displayResults(type = 'array') {
        if (type === 'number') {
            ...
            console.log(`String passed, poll results are ${this.answers.join(', ')} `);
    }
};
...
// external poll results can be displayed by redefining this to call answers.
poll.displayResults.call({answers: [5, 2, 3]}, 'number');
